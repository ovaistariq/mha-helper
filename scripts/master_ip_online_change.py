...
# --command=stop --orig_master_host=master1 --orig_master_ip=10.20.111.6 
# --orig_master_port=3306 --new_master_host=slave1 
# --new_master_ip=10.20.102.5 --new_master_port=3306  
